...
function Card({ icon: Icon, label, value, hint }) {
  return (
    <article className="min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 shadow-sm">
      ...
      <p className="mt-1 max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-base font-semibold leading-tight tracking-tight sm:text-lg xl:text-[1.4rem] 2xl:text-[1.6rem]">
        {value}
      </p>
...
export default function SummaryCards({ income, total, count, budget, remaining, balance }) {
